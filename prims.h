...
PRIM( DUP, x = dpop; dpsh = x; dpsh = x; , dget( 1 ); dput( 2 ); ; )
PRIM( NIP, y = dpop; x = dpop; dpsh = y; , dget( 2 ); dput( 1 ); ; )
PRIM( SWAP, y = dpop; x = dpop; dpsh = y; dpsh = x; , dget( 2 ); dput( 2 ); ; )
PRIM( OVER, y = dpop; x = dpop; dpsh = x; dpsh = y; dpsh = x; , dget( 2 ); dput( 3 ); ; )
PRIM( TUCK, y = dpop; x = dpop; dpsh = y; dpsh = x; dpsh = y; , dget( 2 ); dput( 3 ); ; )
PRIM( ROT, z = dpop; y = dpop; x = dpop; dpsh = y; dpsh = z; dpsh = x; , dget( 3 ); dput( 3 ); ; )
PRIM( TOR, z = dpop; y = dpop; x = dpop; dpsh = z; dpsh = x; dpsh = y; , dget( 3 ); dput( 3 ); ; )
